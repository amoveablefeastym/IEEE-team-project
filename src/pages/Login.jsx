    ...
    <div className="min-h-screen flex items-center justify-center bg-purple-50">
      <div className="bg-white p-10 rounded-2xl shadow-sm border border-purple-100 space-y-8 w-full max-w-sm text-center">
        <div>
            ...
            <p className="text-gray-500 text-sm font-medium">Log in to view your classes</p>
        </div>
        <button 
          onClick={handleLogin}
          className="w-full flex items-center justify-center gap-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-4 rounded-xl transition-colors shadow-sm"
        >
